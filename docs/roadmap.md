...
status. Checkboxes describe verified repository state, not intent. The original
Notion brief remains a product and vision reference; implementation status is
